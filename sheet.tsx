...
export default function Index() {
  ...
  return (
    <div className="flex flex-col items-center min-h-[calc(100vh-4rem)] justify-center w-full text-center p-4">
      <div className="w-full max-w-3xl bg-white dark:bg-gray-900 rounded-2xl p-6 sm:p-10 shadow-sm border border-gray-100 dark:border-gray-800 transition-all">
        ...
        <div className="mt-8 space-y-4 text-left">
          ...
          <div className="bg-gray-50/70 dark:bg-gray-800/40 border border-gray-200/80 dark:border-gray-800 rounded-xl p-3 max-h-80 overflow-y-auto space-y-2 divide-y divide-gray-100 dark:divide-gray-800/60">
            {isLoading ? (
              ...
              projects.map((project) => (
                <div key={project.id} className="pt-2 first:pt-0 space-y-1">
                  {/* Projet sans sous-modules -> Lien Direct */}
                  {!project.hasModules ? (
                    <Link
                    ...
                    /* Projet avec sous-modules -> Entête du Dossier Parent */
                    <div className="space-y-1">
                      ...
                      {/* Liste indentée des sous-modules */}
